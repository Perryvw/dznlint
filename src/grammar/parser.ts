...
export type namespace_statement =
    | namespace_statement_1
    | namespace_statement_2
    | namespace_statement_3
    | namespace_statement_4;
...
export type behavior_statement =
    | behavior_statement_1
    | behavior_statement_2
    | behavior_statement_3
    | behavior_statement_4
    | behavior_statement_5
    | behavior_statement_6;
...
export type imperative_statement =
    | imperative_statement_1
    | imperative_statement_2
    | imperative_statement_3
    | imperative_statement_4
    | imperative_statement_5;
...
export class Parser {
    ...
    public matchnamespace_root($$dpth: number, $$cr?: ErrorTracker): Nullable<namespace_root> {
        return this.run<namespace_root>($$dpth, () => {
            ...
            if (
                true &&
                ($scope$statements = this.loop<namespace_root_$0>(
                    () => this.matchnamespace_root_$0($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchinterface_definition($$dpth: number, $$cr?: ErrorTracker): Nullable<interface_definition> {
        return this.run<interface_definition>($$dpth, () => {
            ...
            if (
                ...
                this.matchBRACE_OPEN($$dpth + 1, $$cr) !== null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$body = this.loop<interface_definition_$0>(
                    () => this.matchinterface_definition_$0($$dpth + 1, $$cr),
                    true
                )) !== null &&
                this.match_($$dpth + 1, $$cr) !== null &&
    ...
    public matchinterface_definition_$0_$0_1(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<interface_definition_$0_$0_1> {
        return this.matchtype($$dpth + 1, $$cr);
    }
    public matchinterface_definition_$0_$0_2(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<interface_definition_$0_$0_2> {
        ...
        return this.run<event>($$dpth, () => {
            ...
            if (
                ...
                $$res = {
                    ...
                    event_params: $scope$event_params,
                };
            }
            return $$res;
        });
    ...
    public matchevent_params($$dpth: number, $$cr?: ErrorTracker): Nullable<event_params> {
        return this.run<event_params>($$dpth, () => {
            ...
            if (
                ...
                ($scope$tail = this.loop<event_params_$0>(() => this.matchevent_params_$0($$dpth + 1, $$cr), true)) !==
                    null
            ) {
    ...
    public matchcomponent($$dpth: number, $$cr?: ErrorTracker): Nullable<component> {
        return this.run<component>($$dpth, () => {
            ...
            if (
                ...
                ($scope$ports = this.loop<component_$0>(() => this.matchcomponent_$0($$dpth + 1, $$cr), true)) !==
                    null &&
    ...
    public matchbody($$dpth: number, $$cr?: ErrorTracker): Nullable<body> {
        return this.choice<body>([() => this.matchbody_1($$dpth + 1, $$cr), () => this.matchbody_2($$dpth + 1, $$cr)]);
    }
    ...
    public matchsystem($$dpth: number, $$cr?: ErrorTracker): Nullable<system> {
        return this.run<system>($$dpth, () => {
            ...
            if (
                ...
                this.matchBRACE_OPEN($$dpth + 1, $$cr) !== null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                ($scope$instances_and_bindings = this.loop<system_$0>(
                    () => this.matchsystem_$0($$dpth + 1, $$cr),
                    true
                )) !== null &&
                this.match_($$dpth + 1, $$cr) !== null &&
                this.matchBRACE_CLOSE($$dpth + 1, $$cr) !== null
    ...
    public matchinstances_and_bindings_$0_$0(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<instances_and_bindings_$0_$0> {
    ...
    public matchinstances_and_bindings_$0_$0_1(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<instances_and_bindings_$0_$0_1> {
        return this.matchinstance($$dpth + 1, $$cr);
    }
    public matchinstances_and_bindings_$0_$0_2(
        $$dpth: number,
        $$cr?: ErrorTracker
    ): Nullable<instances_and_bindings_$0_$0_2> {
        return this.matchbinding($$dpth + 1, $$cr);
    }
    ...
    public matchend_point_$0($$dpth: number, $$cr?: ErrorTracker): Nullable<end_point_$0> {
        return this.run<end_point_$0>($$dpth, () => {
            ...
            if (true && this.matchDOT($$dpth + 1, $$cr) !== null && this.matchASTERISK($$dpth + 1, $$cr) !== null) {
    ...
    public matchformal_list($$dpth: number, $$cr?: ErrorTracker): Nullable<formal_list> {
        return this.run<formal_list>($$dpth, () => {
            ...
            if (
                ...
                ($scope$tail = this.loop<formal_list_$0>(() => this.matchformal_list_$0($$dpth + 1, $$cr), true)) !==
                    null
            ) {
        ...
        return this.run<on>($$dpth, () => {
            ...
            if (
                ...
                $$res = {
                    ...
                    on_trigger_list: $scope$on_trigger_list,
    ...
    public matchon_trigger_list($$dpth: number, $$cr?: ErrorTracker): Nullable<on_trigger_list> {
        return this.run<on_trigger_list>($$dpth, () => {
            ...
            if (
                ...
                ($scope$tail = this.loop<on_trigger_list_$0>(
                    () => this.matchon_trigger_list_$0($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchon_formal_list($$dpth: number, $$cr?: ErrorTracker): Nullable<on_formal_list> {
        return this.run<on_formal_list>($$dpth, () => {
            ...
            if (
                ...
                ($scope$tail = this.loop<on_formal_list_$0>(
                    () => this.matchon_formal_list_$0($$dpth + 1, $$cr),
                    true
                )) !== null
            ) {
    ...
    public matchnumeric_literal($$dpth: number, $$cr?: ErrorTracker): Nullable<numeric_literal> {
        return this.run<numeric_literal>($$dpth, () => {
            ...
            if (true && ($scope$text = this.matchNUMBER($$dpth + 1, $$cr)) !== null) {
    ...
    public matchsl_comment($$dpth: number, $$cr?: ErrorTracker): Nullable<sl_comment> {
        return this.run<sl_comment>($$dpth, () => {
            ...
            if (true && ($scope$text = this.regexAccept(String.raw`(?://[^\n]*\n)`, $$dpth + 1, $$cr)) !== null) {
    ...
    public matchml_comment($$dpth: number, $$cr?: ErrorTracker): Nullable<ml_comment> {
        return this.run<ml_comment>($$dpth, () => {
            ...
            if (
                ...
                ($scope$text = this.loop<ml_comment_$0>(() => this.matchml_comment_$0($$dpth + 1, $$cr), true)) !==
                    null &&
