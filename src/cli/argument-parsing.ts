...
type ParsedCommandLineArguments = { success: false, message: string } | { success: true, arguments: CommandLineArguments }
        ...
        if (args[index].startsWith("--")) {
            switch (args[index]) {
                ...
                case "--config-file":
                    ...
                    break;
                default:
                    return { success: false, message: `Unknown cli option: ${args[index]}. See --help for supported arguments.` };
            }
        } else {
